...
public class Level_02_Register_Inheritance extends BasePage {
    ...
    public void Register_02_Invalid_Email() {
        ...
        sendkeyToElement(driver, "//input[@id='Email']", "abcdef@abcde@abc");
    ...
    public void Register_04_Incorrect_Confirm_Password() {
        ...
        sendkeyToElement(driver, "//input[@id='LastName']", "FC");
        sendkeyToElement(driver, "//input[@id='Email']", getRandomEmail());
        sendkeyToElement(driver, "//input[@id='Password']", "12356");
